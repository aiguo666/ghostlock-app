 ...
 * fdatasync flushes data + size metadata. Called explicitly before
 * fork/clone/corrupting writes, i.e. the points where a hang or panic is
 * most likely. Not called from log_line() so route timing stays unchanged. */
